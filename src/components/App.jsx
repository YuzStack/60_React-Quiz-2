  ...
  switch (action.type) {
    ...
    case 'startQuiz':
      return {
        ...curState,
        status: 'active',
        secsRemaining: curState.questions.length * SECS_PER_QUESTION,
      };
    case 'newAnswer':
    ...
    case 'reduceTime':
      const hasTimeLeft = curState.secsRemaining > 1;
      return {
        ...curState,
        secsRemaining: curState.secsRemaining - 1,
        status: hasTimeLeft ? curState.status : 'finished',
      };
    default:
